...
function MissionBottles:draw()
  ...
  if self.isRunning then
    ...
    setTextBold(true)
    renderText(self.hudMissionBasePosX + 0.005, 0.94, 0.032, g_i18n:getText("bottlesMissionGoal1"))
    renderText(self.hudMissionBasePosX + 0.005, 0.9099999999999999, 0.032, g_i18n:getText("bottlesMissionGoal2"))
    setTextAlignment(RenderText.ALIGN_RIGHT)
    renderText(self.hudMissionBasePosX + self.hudMissionBaseWidth - 0.015, 0.94, 0.032, string.format("%d", self.foundBottleCount))
    renderText(self.hudMissionBasePosX + self.hudMissionBaseWidth - 0.015, 0.9099999999999999, 0.032, string.format("%d", self.deliveredBottles))
