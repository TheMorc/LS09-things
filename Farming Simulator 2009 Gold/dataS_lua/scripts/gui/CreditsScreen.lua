...
function CreditsScreen:new(backgroundOverlay)
  ...
  table.insert(instance.creditsTexts, "Renzo Thoenen")
  table.insert(instance.creditsTexts, "")
  ...
  table.insert(instance.creditsTexts, "")
  table.insert(instance.creditsTexts, "Community Manager")
  table.insert(instance.creditsTexts, "Chris Wachter")
  table.insert(instance.creditsTexts, "Horst Goetzl")
  table.insert(instance.creditsTexts, "")
  ...
  table.insert(instance.creditsTexts, "Hans Imboden")
  table.insert(instance.creditsTexts, "Martin Baerwolf")
  table.insert(instance.creditsTexts, "")
  ...
  table.insert(instance.creditsTexts, "")
  table.insert(instance.creditsTexts, "Poettinger (www.poettinger.at)")
  table.insert(instance.creditsTexts, "Copyright (C) Alois Poettinger Maschinenfabrik Ges.m.b.H.")
  table.insert(instance.creditsTexts, "")
  table.insert(instance.creditsTexts, "Horsch (www.horsch.com)")
  table.insert(instance.creditsTexts, "Copyright (C) HORSCH Maschinen GmbH")
  table.insert(instance.creditsTexts, "")
