...
function StoreMenu:render()
  ...
  if self.showNoMoreSpaceMessage then
    ...
    setTextColor(0, 0, 0, 1)
    renderText(0.498, 0.697, 0.041, g_i18n:getText("StoreNoSpace"))
    renderText(0.5, 0.697, 0.041, g_i18n:getText("StoreNoSpace"))
    renderText(0.502, 0.697, 0.041, g_i18n:getText("StoreNoSpace"))
    renderText(0.498, 0.7, 0.041, g_i18n:getText("StoreNoSpace"))
    renderText(0.502, 0.7, 0.041, g_i18n:getText("StoreNoSpace"))
    renderText(0.498, 0.703, 0.041, g_i18n:getText("StoreNoSpace"))
    renderText(0.5, 0.703, 0.041, g_i18n:getText("StoreNoSpace"))
    renderText(0.502, 0.703, 0.041, g_i18n:getText("StoreNoSpace"))
    setTextColor(1, 0, 0, 1)
    renderText(0.5, 0.7, 0.041, g_i18n:getText("StoreNoSpace"))
    setTextAlignment(RenderText.ALIGN_LEFT)
    setTextColor(1, 1, 1, 1)
    setTextBold(false)
  end
