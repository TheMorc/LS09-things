...
function MissionStats:new()
  ...
  instance.pdaMapOverlay = Overlay:new("pdaMapOverlay", "dataS/missions/pda_map.png", instance.pdaMapPosX, instance.pdaMapPosY, instance.pdaMapWidth, instance.pdaMapHeight)
