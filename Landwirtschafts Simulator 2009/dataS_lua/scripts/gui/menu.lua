...
function GameMenuSystem:init()
  ...
  self.settingsMenu.profileTextOp = OverlayMultiTextOption:new(profileTable, down, up, settings_textX + 0.095, settings_posY - settings_spaceY * 4 - settings_menu_border - settings_offsetY, 0.045, Utils.getProfileClassIndex(g_settingsDisplayProfile), OnSettingsMenuGPUProfile)
...
function GameMenuSystem:render()
  if self.currentMenu ~= nil then
    ...
    if self.currentMenu == self.settingsMenu then
      ...
      renderText(0.61, 0.5, 0.045, g_i18n:getText("Resolution"))
      renderText(0.61, 0.43, 0.045, g_i18n:getText("MSAA"))
      renderText(0.61, 0.36, 0.045, g_i18n:getText("AnisotropicFiltering"))
      renderText(0.61, 0.29, 0.045, g_i18n:getText("JoystickGamepad"))
      renderText(0.61, 0.22, 0.045, g_i18n:getText("HardwareProfile"))
      renderText(0.61, 0.15, 0.045, g_i18n:getText("TimeScale"))
      renderText(0.61, 0.08, 0.045, g_i18n:getText("AutomaticHelp"))
      setTextBold(false)
