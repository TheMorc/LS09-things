...
function init()
  ...
  FruitUtil.registerFruitType("grass", false, true, true, 3, 0.35, 2, 0.01, 0.5, "dataS/missions/hud_fruit_grass.png")
...
function loadMod(modName, modDir, modFile)
  ...
  while true do
    ...
    if not StoreItemsUtil.loadStoreItem(xmlFile, baseName, modDir) then
      break
    end
    i = i + 1
  end
