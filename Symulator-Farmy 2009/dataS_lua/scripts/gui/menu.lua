...
function GameMenuSystem:init()
  ...
  local font_size = 0.038
  if g_showSplashScreen then
    self.splashScreen = SplashScreen:new(GameMenuSystem.mainMenuMode, self)
    self.splashScreen:addScreen(Overlay:new("splash1", "dataS/menu/intro01" .. g_languageSuffix .. ".png", 0, 0, 1, 1))
    self.splashScreen:addScreen(Overlay:new("splash2", "dataS/menu/intro02" .. g_languageSuffix .. ".png", 0, 0, 1, 1))
    self.splashScreen:addScreen(Overlay:new("splash3", "dataS/menu/intro03" .. g_languageSuffix .. ".png", 0, 0, 1, 1))
  end
  ...
  self.settingsMenu:addItem(OverlayButton:new(Overlay:new("settings_save_button", "dataS/menu/save_button" .. g_languageSuffix .. ".png", settings_menu_posX, settings_menu_posY - settings_menu_spaceY * 0, settings_menu_sizeX, settings_menu_sizeY), OnSettingsMenuSave))
  self.settingsMenu:addItem(OverlayButton:new(Overlay:new("settings_back_button", "dataS/menu/back_button" .. g_languageSuffix .. ".png", settings_menu_posX, settings_menu_posY - settings_menu_spaceY * 1, settings_menu_sizeX, settings_menu_sizeY), OnSettingsMenuBack))
  ...
  local msaaTable = {}
  table.insert(msaaTable, g_i18n:getText("settingsOff"))
  ...
  self.settingsMenu.msaaTextOp = OverlayMultiTextOption:new(msaaTable, down, up, settings_textX + 0.095, settings_posY - settings_spaceY * 1 - settings_menu_border - settings_offsetY, font_size, Utils.getMSAAIndex(g_settingsMSAA), OnSettingsMenuMSAA)
  self.settingsMenu:addItem(self.settingsMenu.msaaTextOp)
  local anisoTable = {}
  table.insert(anisoTable, g_i18n:getText("settingsOff"))
  ...
  self.settingsMenu.ansioTextOp = OverlayMultiTextOption:new(anisoTable, down, up, settings_textX + 0.095, settings_posY - settings_spaceY * 2 - settings_menu_border - settings_offsetY, font_size, Utils.getAnsioIndex(g_settingsAnsio), OnSettingsMenuAniso)
  ...
  local profileTable = {}
  table.insert(profileTable, string.format("Auto (%s)", self.getAutoValue()))
  table.insert(profileTable, g_i18n:getText("settingsLow"))
  table.insert(profileTable, g_i18n:getText("settingsMedium"))
  table.insert(profileTable, g_i18n:getText("settingsHigh"))
  table.insert(profileTable, g_i18n:getText("settingsVeryHigh"))
  ...
  self.settingsMenu.profileTextOp = OverlayMultiTextOption:new(profileTable, down, up, settings_textX + 0.095, settings_posY - settings_spaceY * 4 - settings_menu_border - settings_offsetY, font_size, Utils.getProfileClassIndex(g_settingsDisplayProfile), OnSettingsMenuGPUProfile)
  self.settingsMenu:addItem(self.settingsMenu.profileTextOp)
  local timeScaleTable = {}
  table.insert(timeScaleTable, g_i18n:getText("settingsRealtime"))
  ...
  self.settingsMenu.timeScaleTextOp = OverlayMultiTextOption:new(timeScaleTable, down, up, settings_textX + 0.095, settings_posY - settings_spaceY * 5 - settings_menu_border - settings_offsetY, font_size, Utils.getTimeScaleIndex(g_settingsTimeScale), OnSettingsMenuTimeScale)
  ...
  if g_showSplashScreen then
    self.currentMenu = self.splashScreen
  else
...
function GameMenuSystem:getAutoValue()
  local AutoGpuMap = {}
  AutoGpuMap.Low = "settingsLow"
  AutoGpuMap.Medium = "settingsMedium"
  AutoGpuMap.High = "settingsHigh"
  AutoGpuMap["Very High"] = "settingsVeryHigh"
  return g_i18n:getText(AutoGpuMap[getAutoGPUPerformanceClass()])
end
